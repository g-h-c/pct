...
..\extractheaderscmd\debug\extractheaders --input readmeexample_test\pct_test\file.cpp --def "WIN32;WIN32;_M_X64" --sysinclude "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\include" --sysinclude "C:\Qt\5.6\5.6\msvc2013_64\include" -o readmeexample_test\pct_test\stdafx.h
